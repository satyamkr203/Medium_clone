            ...
            {activeModal === 'SignUpModal' && (
                <Modal show={show} onClose={onClose} className=" w-auto  h-screen">
                    ...
                    <Modal.Body className="flex flex-col items-center">
                        <div className="mb-4">
                            <h1 className="text-3xl  font-extralight font-serif text-center">First create an account</h1>
                            <div className="flex flex-col text-center flex-wrap mt-10 font-sans opacity-70">
                                <p>Once you've created your account, you'll be
                                </p>
                                <p>able to upgrade for unlimited access to </p>
                                <p>Medium.</p>
                            </div>
                        </div>
